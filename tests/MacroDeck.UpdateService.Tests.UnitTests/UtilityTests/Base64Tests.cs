...
public class Base64Tests
{
    ...
    {
        var testString = SharedTestConstants.Base64TestStringPlain;
        var testStringBase64 = Base64Utils.Base64Encode(testString);
        
        Assert.That(testStringBase64, Is.EqualTo(SharedTestConstants.Base64TestStringBase64));
    }

    [Test]
    public void Base64Decode_Returns_Correct_String()
    {
        var testStringBase64 = SharedTestConstants.Base64TestStringBase64;
        var testString = Base64Utils.Base64Decode(testStringBase64);
        
        Assert.That(testString, Is.EqualTo(SharedTestConstants.Base64TestStringPlain));
    }
}